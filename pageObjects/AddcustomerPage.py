...
class AddCustomer:
    # Add customer Page
    lnkCustomers_menu_xpath = "//nav[@class='mt-2']//li[@class='nav-item has-treeview']/a/p[contains(text(),'Customers')]"
    ...
    #  //nav[@class='mt-2']//li[contains(@class,'nav-item')]/a/p[normalize-space(text())='Catalog']